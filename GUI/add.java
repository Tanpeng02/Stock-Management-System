...
public class add {
	 ...
	 Button invalid3 = new Button("The product has been discountinued, Click to back menu");
	 public add(ArrayList<Product> productList) {
	 ...
	 public void set(ArrayList<Product> productList) {
		 ...
		 Label name = new Label("Enter the number.");
		    ...
		    Label number = new Label("Enter the quantity to add.");
		    ...
		    module.add(invalid3, 0, productList.size() + 8);
